...
- Name: fr16-product-import.spec.js >> FR-16: Product Import from CSV >> TC07 - Import CSV file with validation errors
- Location: tests\fr16-product-import.spec.js:160:3
        ...
        - table [ref=e27]:
          ...
          - rowgroup [ref=e35]:
            - row "Áo sơ mi nam 250000 Áo sơ mi cotton cao cấp https://placehold.co/300 1" [ref=e36]:
              ...
              - cell "1" [ref=e41]
            - row "350000 Quần jean ống rộng thời trang https://placehold.co/300 2" [ref=e42]:
              - cell [ref=e43]
              - cell "350000" [ref=e44]
              - cell "Quần jean ống rộng thời trang" [ref=e45]
              - cell "https://placehold.co/300" [ref=e46]
              - cell "2" [ref=e47]
            - row "Giày thể thao -100000 Giày sneaker phong cách https://placehold.co/300 3" [ref=e48]:
            ...
            - row "Túi xách da 550000 Túi xách da thật cao cấp https://placehold.co/300 4" [ref=e54]:
              ...
              - cell "4" [ref=e59]
            - row "Đồng hồ nam abc Đồng hồ cơ automatic https://placehold.co/300 5" [ref=e60]:
...
> 180 |     await importButton.click();
  ...
  226 |       headers: {
  227 |         'Authorization': `Bearer ${adminToken}`
  228 |       },
  229 |       data: {
  230 |         products: [
  231 |           {
  ...
  235 |             imageUrl: 'https://placehold.co/300',
  236 |             category_id: 1
  237 |           }
  238 |         ]
  239 |       }
  ...
  244 |     expect(data.errors.length).toBeGreaterThan(0);
  245 |     expect(data.errors[0]).toContain('Thiếu tên sản phẩm');
  246 |   });
  247 | 
  248 |   // TC10: API test - Import with negative price
  249 |   test('TC10 - API: Import with negative price', async ({ request }) => {
  250 |     const response = await request.post(`${API_URL}/api/admin/import-products`, {
  251 |       headers: {
  ...
  255 |         products: [
  256 |           {
  257 |             name: 'Test Product',
  258 |             price: -100000,
  259 |             description: 'Test description',
  260 |             imageUrl: 'https://placehold.co/300',
  261 |             category_id: 1
  262 |           }
  263 |         ]
  264 |       }
  265 |     });
  266 |     
  267 |     expect(response.ok()).toBeTruthy();
  268 |     const data = await response.json();
  269 |     // Should either have errors or insert with issues
  270 |     expect(data).toHaveProperty('inserted');
  271 |   });
  272 | 
  273 |   // TC11: API test - Import empty array
  274 |   test('TC11 - API: Import empty array', async ({ request }) => {
  275 |     const response = await request.post(`${API_URL}/api/admin/import-products`, {
  276 |       headers: {
